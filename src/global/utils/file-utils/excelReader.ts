...
// // pageName = filter for this page (optional)
// export function loadLocatorsFromExcel(
//   filePath: string,
//   pageName?: string
// ): Record<string, LocatorConfig> {
//   const workbook = XLSX.readFile(filePath);
//   const sheetName = workbook.SheetNames[0]; // assuming single sheet
//   const sheet = workbook.Sheets[sheetName];

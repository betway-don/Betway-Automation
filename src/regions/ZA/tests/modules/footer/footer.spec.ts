...
test.describe('Footer Module Tests', () => {
    ...
    //     await homePage.HomePagelocatorsRegistry.footer.waitFor({ state: 'visible', timeout: 10000 });
    //     await highlightElements(homePage.HomePagelocatorsRegistry.footer);
    ...
    //     await homePage.HomePagelocatorsRegistry.betwayLogo.waitFor({ state: 'visible', timeout: 10000 })
    //     await highlightElements(homePage.HomePagelocatorsRegistry.betwayLogo);
    ...
    //     await homePage.HomePagelocatorsRegistry.betwayLogo.waitFor({ state: 'visible', timeout: 10000 });
    //     await homePage.HomePagelocatorsRegistry.betwayLogo.hover();
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.betwayLogo);
    ...
    //     await homePage.HomePagelocatorsRegistry.betwayLogo.click();
    ...
    //     await homePage.HomePagelocatorsRegistry.arsenalLogo.hover();
    //     await highlightElements(homePage.HomePagelocatorsRegistry.arsenalLogo.locator('..').locator('..'));
    ...
    //     await homePage.HomePagelocatorsRegistry.arsenalLogo.click();
    ...
    //     await homePage.HomePagelocatorsRegistry.Sponsorships.click();
    //     await expect(homePage.page).toHaveURL('https://new.betway.co.za/sponsorship', { timeout: 10000 });
    //     await homePage.page.waitForLoadState('domcontentloaded');
    ...
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.PrivacyPolicy);
    //     await ScreenshotHelper(homePage.page, screenshotDir, 'T12-a.png', testInfo);
    //     await homePage.HomePagelocatorsRegistry.PrivacyPolicy.click();
    ...
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.ContactUs);
    //     await ScreenshotHelper(homePage.page, screenshotDir, 'T14-a.png', testInfo);
    //     await homePage.HomePagelocatorsRegistry.ContactUs.click();
    ...
    //     await highlightElementBorder(contactUsPage.ContactUsPagelocatorRegistry.chatToLiveSupport);
    ...
    //     await homePage.page.waitForLoadState('domcontentloaded');
    //     const contactUsPage = new ContactUsPage(homePage.page);
    //     await highlightElementBorder(contactUsPage.ContactUsPagelocatorRegistry.call);
    ...
    //     await homePage.page.waitForLoadState('domcontentloaded');
    //     const contactUsPage = new ContactUsPage(homePage.page);
    //     await highlightElementBorder(contactUsPage.ContactUsPagelocatorRegistry.email);
    ...
    //     await homePage.page.waitForLoadState('domcontentloaded');
    //     const contactUsPage = new ContactUsPage(homePage.page);
    //     await highlightElementBorder(contactUsPage.ContactUsPagelocatorRegistry.X);
    ...
    //     await homePage.page.waitForLoadState('domcontentloaded');
    //     const contactUsPage = new ContactUsPage(homePage.page);
    //     await highlightElementBorder(contactUsPage.ContactUsPagelocatorRegistry.facebook);
    ...
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.ContactUs);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.arsenalLogo.locator('..').locator('..'));
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.betwayLogo);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.linkToSocials.locator('..').locator('..'));
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.PrivacyPolicy);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.FAQs);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.howtobet);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.TermsAndConditions);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.BetwayApp);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.ResponsibleGaming);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.BettingRules);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.AffiliateProgram);
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.appleLogo.locator('..').locator('..'));
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.Sponsorships);
    ...
    test('T19-Verify functionality of "Dialing code" dropdown', async ({ homePage }, testInfo) => {
        await homePage.HomePagelocatorsRegistry.ContactUs.click();
        const contactUsPage = new ContactUsPage(homePage.page);
        await expect(contactUsPage.ContactUsPagelocatorRegistry.formMobileInput).toBeVisible({ timeout: 10000 });
    });
    ...
    test('T22-Verify that it should not accept special character in "Email Address" filed', async ({ homePage }, testInfo) => {
        await homePage.HomePagelocatorsRegistry.ContactUs.click();
        const contactUsPage = new ContactUsPage(homePage.page);
        await expect(contactUsPage.ContactUsPagelocatorRegistry.formEmailInput).toBeVisible({ timeout: 10000 });
    });
    ...
    test('T24-Verify contents of "Query Type" dropdown', async ({ homePage }, testInfo) => {
        ...
        const contactUsPage = new ContactUsPage(homePage.page);
        await expect(contactUsPage.ContactUsPagelocatorRegistry.formQueryType).toBeVisible({ timeout: 10000 });
    });
    ...
    test('T26-Verify functionality of "Query Type" dropdown', async ({ homePage }, testInfo) => {
        ...
        const contactUsPage = new ContactUsPage(homePage.page);
        await expect(contactUsPage.ContactUsPagelocatorRegistry.formQueryType).toBe
    });
    test('T27-Verify functionality of "Query Field" comment text box', async ({ homePage }, testInfo) => {
        await homePage.HomePagelocatorsRegistry.ContactUs.click();

        const contactUsPage = new ContactUsPage(homePage.page);
        await expect(contactUsPage.ContactUsPagelocatorRegistry.formQueryInput).toBeVisible({ timeout: 10000 });
    });
    ...
    test('T28-Verify functionality of "Submit" button"', async ({ homePage }, testInfo) => {
        ...
        const contactUsPage = new ContactUsPage(homePage.page);
        await expect(contactUsPage.ContactUsPagelocatorRegistry.formSubmitButton).toBeVisible({ timeout: 10000 });
    });
    ...
    //     await homePage.HomePagelocatorsRegistry.FAQs.click();
    ...
    //     await homePage.HomePagelocatorsRegistry.ResponsibleGaming.click();
    ...
    //     await homePage.HomePagelocatorsRegistry.TermsAndConditions.click();
    ...
    //     await highlightElements(homePage.HomePagelocatorsRegistry.TermsAndConditions);
    //     await homePage.HomePagelocatorsRegistry.TermsAndConditions.click();
    //     await expect(homePage.page).toHaveURL('https://new.betway.co.za/terms-and-conditions', { timeout: 10000 });
    ...
    //     await highlightElements(homePage.HomePagelocatorsRegistry.BettingRules);
    //     await ScreenshotHelper(homePage.page, screenshotDir, 'T32-a.png', testInfo);
    //     await homePage.HomePagelocatorsRegistry.BettingRules.click();
    ...
    //     await homePage.HomePagelocatorsRegistry.BetwayApp.click();
    ...
    //     await homePage.HomePagelocatorsRegistry.howtobet.click();
    ...
    //     await homePage.HomePagelocatorsRegistry.version.waitFor({ state: 'visible', timeout: 3000 })
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.version);
    ...
    //     await homePage.HomePagelocatorsRegistry.currentTime.waitFor({ state: 'visible' })
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.currentTime);
    ...
    //     await homePage.HomePagelocatorsRegistry.downloadBetwayApp.waitFor({ state: 'visible', timeout: 30000 })
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.downloadBetwayApp.locator('..').locator('..'));
    //     await homePage.page.waitForTimeout(5000);
    ...
    //     await homePage.HomePagelocatorsRegistry.appleLogo.waitFor({ state: 'visible', timeout: 30000 });
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.appleLogo);
    //     await homePage.page.waitForTimeout(5000);
    ...
    //     await homePage.HomePagelocatorsRegistry.linkToSocials.waitFor({ state: 'visible', timeout: 30000 })
    //     await highlightElementBorder(homePage.HomePagelocatorsRegistry.linkToSocials.locator('..').locator('..'));
    //     await homePage.page.waitForTimeout(5000);
    ...
    //     const logos = await homePage.HomePagelocatorsRegistry.arsenalLogo.locator('..').locator('..');

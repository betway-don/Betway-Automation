...
- main:
  ...
  - 'heading "Play at Betway Casino: Fixed-Odds Games, Endless Fun" [level=2]'
  - paragraph:
    ...
    - strong: Crazy Time
    - text: or Mega Ball? Then take your seat and get ready to play. From Aviator to Sic Bo, from Baccarat to Lightning Dice, the possibilities offered by Betway are practically endless if you’re looking for a modern, fun and thrilling casino experience.
...
- contentinfo:
  ...
  - text: ". Warning:Gambling involves risk. Gambling on this website, you run the risk that you may lose. Version: 15.0.0 | Current time: 12:42:08 © 2025 Betway Download the Betway app Scan the QR code to initiate the app download Click the respective icon to download"
  - link "apple-logo":

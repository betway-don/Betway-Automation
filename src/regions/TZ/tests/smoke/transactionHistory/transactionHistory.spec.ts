// npx playwright test src/regions/TZ/tests/smoke/transactionHistory/transactionHistory.spec.ts --config=playwright.TZ.config.ts --headed
...
test.describe('Transaction History Module Tests', () => {
    ...
    test('T2: Verify all tabs click and take screenshots', async ({ transactionHistoryPage }, testInfo) => {
        ...
        const tabs = [
            ...
            { name: 'virtualsBtn', locatorName: 'virtualsBtn', screenshot: 'T2f-Virtuals' },
            { name: 'jackpotsBtn', locatorName: 'jackpotsBtn', screenshot: 'T2g-Jackpots' },
            { name: 'betgamesBtn', locatorName: 'betgamesBtn', screenshot: 'T2h-Betgames' },

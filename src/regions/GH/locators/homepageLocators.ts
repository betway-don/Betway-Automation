...
export const homepageLocators = {
    howtobet: { selector: 'link', options: { name: 'How to Bet' }, nth: 0 },
    ...
    BetwayApp: { selector: 'link', options: { name: 'Betway App' }, nth: 0},
    ...
    linkToSocials: { selector: 'a[href="https://x.com/betway_gh"]' },
}
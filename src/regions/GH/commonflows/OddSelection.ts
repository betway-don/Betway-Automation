...
//     const apiUrl = "https://www.betway.com.gh/sportsapi/br/v1/BetBook/Highlights/?countryCode=GH&sportId=soccer";
...
//     await page.reload({ waitUntil: 'domcontentloaded' });
//     const apiUrl = "https://www.betway.com.gh/sportsapi/br/v1/BetBook/Highlights/?countryCode=GH&sportId=esports-league-of-legends&Skip=0&Take=20&cultureCode=en-US&isEsport=true&boostedOnly=false&marketTypes=%5BMatch%20Winner%5D";
//     const response = await page.waitForResponse((resp: { url: () => string; status: () => number; }) => resp.url().startsWith(apiUrl) && resp.status() === 200);
//     const data = await response.json();
...
//     const apiUrl = "https://www.betway.com.gh/sportsapi/br/v1/BetBook/LiveInPlay/?countryCode=GH&sportId=table-tennis"
//     const response = await page.waitForResponse((resp: { url: () => string; status: () => number; }) => resp.url().startsWith(apiUrl) && resp.status() === 200);
//     const data = await response.json();
//     for (let i = 0; i < numberOfLegs; i++) {
//         const eventId = data.events?.[i]?.eventId;
...
//     const apiUrl = "https://www.betway.com.gh/sportsapi/br/v1/BetBook/Upcoming/?countryCode=GH&sportId=socce";

...
export class HomePage {
    ...
    constructor(page: import('@playwright/test').Page) {
        ...
        this.footerLinksContainer = this.ContactUs.locator('..');
        this.FAQs = this.footerLinksContainer.getByRole('link',{name:homepageLocators.FAQs.options.name}).nth(homepageLocators.FAQs.nth || 0);
        this.TermsAndConditions = this.footerLinksContainer.getByText(homepageLocators.TermsAndConditions.options.name).nth(homepageLocators.TermsAndConditions.nth || 0);
        this.BettingRules = this.footerLinksContainer.getByRole('link',{name:homepageLocators.BettingRules.options.name}).nth(homepageLocators.BettingRules.nth || 0);
        this.BetwayApp = this.footerLinksContainer.getByRole('link',{name:homepageLocators.BetwayApp.options.name}).nth(homepageLocators.BetwayApp.nth || 0);
        this.AffiliateProgram = this.footerLinksContainer.getByRole('link',{name:homepageLocators.AffiliateProgram.options.name}).nth(homepageLocators.AffiliateProgram.nth || 0);
        this.ResponsibleGaming = this.footerLinksContainer.getByText(homepageLocators.ResponsibleGaming.options.name).nth(homepageLocators.ResponsibleGaming.nth || 0);
        this.PrivacyPolicy = this.footerLinksContainer.getByText(homepageLocators.PrivacyPolicy.options.name).nth(homepageLocators.PrivacyPolicy.nth || 0);
        this.Sponsorships = this.footerLinksContainer.getByText(homepageLocators.Sponsorships.options.name).nth(homepageLocators.Sponsorships.nth || 0);

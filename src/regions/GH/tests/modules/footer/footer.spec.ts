...
test.describe('Footer Module Tests', () => {
    ...
    //     await expect(homePage.page).toHaveURL('/sponsorship', { timeout: 10000 });
    ...
    //     await homePage.arsenalLogo.click();
    //     await homePage.page.waitForLoadState('load');
    //     await expect(homePage.page).toHaveURL('/sponsorship');
    ...
    //     await expect(homePage.page).toHaveURL('/', { timeout: 10000 });
    ...
    //     await expect(homePage.page).toHaveURL('/privacy-policy', { timeout: 10000 });
    //     await homePage.page.waitForLoadState('load');
    ...
    //     await expect(homePage.page).toHaveURL('/contact-us', { timeout: 10000 });
    ...
    //     const contactUsPage = await homePage.creatContactUsPage(homePage.page);
    ...
    //     await expect(contactUsPage.page).toHaveURL('/contact-us?livechat=true', { timeout: 10000 });
    ...
    test('T20-Verify that user should able to see "Mobile Number" filed', async ({ homePage }, testInfo) => {
        ...
        await homePage.ContactUs.click();
        await homePage.page.waitForLoadState('domcontentloaded');
        await highlightElementBorder(contactUsPage.mobile_input);
        await ScreenshotHelper(contactUsPage.page, screenshotDir, 'ContactUs1.png', testInfo);
    });
    test('T21-Verify functionality of "Mobile Number" text box', async ({ homePage }, testInfo) => {
        ...
        await homePage.ContactUs.click();
        await homePage.page.waitForLoadState('domcontentloaded');
        await contactUsPage.mobile_input.fill(`233${userData.user1.mobile}`);
        await highlightElementBorder(contactUsPage.mobile_input);
        await ScreenshotHelper(contactUsPage.page, screenshotDir, 'ContactUs2.png', testInfo);
    });
    ...
    test('T23-Verify that it should accept only valid data in "Email Address" filed', async ({ homePage }, testInfo) => {
        ...
        await homePage.page.waitForLoadState('domcontentloaded');
        await highlightElementBorder(contactUsPage.mobile_input);
        await ScreenshotHelper(contactUsPage.page, screenshotDir, 'ContactUs3.png', testInfo);
    });
    ...
    test('T27-Verify functionality of "Query Field" comment text box', async ({ homePage }, testInfo) => {
        ...
        await homePage.ContactUs.click();
        await homePage.page.waitForLoadState('domcontentloaded');
        await highlightElementBorder(contactUsPage.query_input);
        await contactUsPage.query_input.fill('Filled by Automation');
        await ScreenshotHelper(contactUsPage.page, screenshotDir, 'ContactUs4.png', testInfo);
    });
    test('T28-Verify functionality of "Submit" button"', async ({ homePage }, testInfo) => {
        ...
        await highlightElementBorder(contactUsPage.query_input);
        await highlightElementBorder(contactUsPage.mobile_input);
        await highlightElementBorder(contactUsPage.email_input);
        await highlightElementBorder(contactUsPage.query_input);
        await contactUsPage.mobile_input.fill(`233${userData.user1.mobile}`);
        await contactUsPage.email_input.fill(userData.user1.email);
        await contactUsPage.query_input.fill('Filled by Automation');
        const [request] = await Promise.all([
            homePage.page.waitForRequest(request =>
                request.url().includes('/api/v1/Content/BetwayContactUs/Mail') &&
                request.method() === 'POST'
            ),
...
//         await homePage.FAQs.click();
//         await expect(homePage.page).toHaveURL('/frequently-asked-questions', { timeout: 10000 });
...
//         await expect(homePage.page).toHaveURL('/responsible-gaming', { timeout: 10000 });
...
//         await expect(homePage.page).toHaveURL('/terms-and-conditions', { timeout: 10000 });
//         await homePage.page.waitForLoadState('domcontentloaded');
...
//         await homePage.page.getByRole('button', { name: "General" }).first().click();
//         await homePage.page.waitForTimeout(2000);
...
//         await expect(homePage.page).toHaveURL('/betway-app', { timeout: 10000 });
...
//         await homePage.BetwayApp.click();
//         await homePage.page.waitForTimeout(4000);
//         await expect(homePage.page).toHaveURL('/betway-app');
...
//         await expect(homePage.page).toHaveURL('/how-to-bet', { timeout: 10000 });
...
//     //     await expect(homePage.page).toHaveURL('/how-to-bet-sms', { timeout: 10000 });
...
//         await highlightElementBorder(homePage.page.getByText('Pre-game').first().locator('..'));
//         await homePage.page.getByText('Pre-game').first().click();
...
//         await homePage.page.waitForLoadState('domcontentloaded');
//         await expect(homePage.page).toHaveURL('/how-to-betgames', { timeout: 10000 });
...
//         await expect(homePage.page).toHaveURL('/how-to-register', { timeout: 10000 });
//         await homePage.page.waitForLoadState('domcontentloaded');
...
//         await expect(homePage.page).toHaveURL('/how-to-deposit', { timeout: 10000 });
//         await homePage.page.waitForLoadState('domcontentloaded');
//         await highlightElementBorder(homePage.page.getByText('MTN USSD').first().locator('..'));
//         await homePage.page.getByText('MTN USSD').first().locator('..').click();
...
//         await homePage.page.waitForLoadState('domcontentloaded');
//         await expect(homePage.page).toHaveURL('/how-to-reset-password', { timeout: 10000 });
//         await highlightElementBorder(homePage.page.getByText('How to Reset Password').first().locator('..'));
...
//         await homePage.page.waitForLoadState('domcontentloaded');
//         await expect(homePage.page).toHaveURL('/how-to-withdraw', { timeout: 10000 });
//         await highlightElementBorder(homePage.page.getByText('How to Withdraw').first().locator('..'));
...
//         await expect(homePage.page).toHaveURL('/how-to-casino', { timeout: 10000 });
...
//         await homePage.page.waitForTimeout(5000);
//         await highlightElements(await homePage.page.getByText('Sports Betting Group Ghana LTD').first().locator('..'));
...
//         const logos = await homePage.linkToSocials.locator('..').locator('..');
//         const eighteenplusLogo = logos.getByRole('link').last();
//         await homePage.page.waitForLoadState('domcontentloaded');
//         await homePage.page.waitForTimeout(5000);
//         await highlightElements(eighteenplusLogo.locator('..'));
